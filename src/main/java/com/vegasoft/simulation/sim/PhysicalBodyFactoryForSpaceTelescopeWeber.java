...
public class PhysicalBodyFactoryForSpaceTelescopeWeber implements PhysicalBodyFactory {
    ...
    public List<Particle> createBodies() {
        List<Particle> pb = new ArrayList<>();
        ...
        earth.setVelocity(Vector3D.create(0.0, 0.0, ORBIT_EARTH_AROUND_SUN_SPEED));
        ...
        Particle telescope = new Particle("Mark Weber Space Telescope");
...
//        telescope.setLocation(Vector3D.convert(l2.mapMultiply(1.1))); // funny
    ...
    private Vector3D calculateL2(Particle b1, Particle b2) {
